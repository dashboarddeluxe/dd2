<template>
    <div class="flex flex-1 justify-end items-center text-right px-4">
        <div
            class="absolute md:relative w-full justify-end bg-black left-0 top-0 z-10 mt-7 md:mt-0 px-4 md:px-0"
        ...
        >
            ...
            <input
                ...
                v-model="query"
                ref="search"
                class="transition-fast relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-gray-800 border border-gray-900 focus:border-blue-900 outline-none cursor-pointer text-gray-400 px-4 pb-0 pt-px"
            ...
            <transition name="fade">
                <div v-if="query" class="absolute left-0 right-0 md:inset-auto w-full lg:w-3/4 text-left mb-4 md:mt-10">
                    <div class="flex flex-col bg-white border border-b-0 border-t-0 border-blue-400 rounded-b-lg shadow-lg mx-4 md:mx-0">
                        ...
                        <div
                            v-if="! results.length"
                            class="bg-white w-full hover:bg-blue-400 border-b border-blue-400 rounded-b-lg shadow cursor-pointer p-4"
                        >
        ...
        <button
            ...
            type="button"
            class="flex md:hidden bg-gray-800 hover:bg-blue-800 justify-center items-center border border-gray-900 rounded-full focus:outline-none h-10 px-3"
